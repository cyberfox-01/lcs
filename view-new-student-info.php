...
<html>
  ...
  <body>
    ...
    <section id="showcase">
      <div class="container">
          <h2><span class = "highlight">Enrollment Application</h2>
        
      </div>
      
        <section id="boxes">
          <form class="container" method ="post" action = "/lcs/includes/generatePDF.php">
              ...
              <tr>
                <td>
                  <div class = "input-group-short">
                    <input type="submit" name = "generatePDF" value = "Generate PDF and Print">
                  </div>
                </td>
